...
func TestGetRedirectDestinationNegative(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.description, func(t *testing.T) {
			...
			resp, err := r.GetRedirectDestination("https://example.com", false)
...
func TestGetRedirectDestinationPoositive(t *testing.T) {
	type mockParam struct {
		resp *http.Response
		err  error
	}
